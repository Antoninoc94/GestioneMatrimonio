...
echo "    Username: sposo   Password: sposo1"
echo "    Username: sposa   Password: sposa1"
echo ""
echo -e "  ${YELLOW}IMPORTANTE: cambia username e password subito dopo il primo accesso!${NC}"
echo ""
